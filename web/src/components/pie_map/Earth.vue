...
export default {
  ...
  data() {
    return {
      ...
      city: [
        {
          img: require('@/assets/4fe6bbc1-c299-41dc-ab5b-23f71e8cf7e2.png_640xaf.png'),
          name: '花莲港',
        ...
        {
          img: require('@/assets/u=2226097721,4194191472&fm=253&fmt=auto&app=120&f=JPEG.webp'),
        ...
        {
          img: require('@/assets/u=751976069,2907256282&fm=253&fmt=auto&app=120&f=JPEG.webp'),
      ...
      if (window.Module == undefined || window.Module == null) {
        ...
        createEarthModule().then(function () {
          viewer = new Earth.Viewer('canvas', {
            ...
            // imageryProvider:new Earth.MapboxImageryProvider({
            //   url:'http://172.16.100.103:9000/mapboxsat/maps?lyrs=i&x={x}&y={y}&z={z}',
            //   // url:'http://172.16.100.104:18081/geoimage/tileapi/tms/1.0.0/global_img_4326-BJ@EPSG:4490@jpeg@0/{x}/{y}/{z}.png'
            // }),
          ...
          viewer.dataSources.add(
            Earth.GeoJsonDataSource.load('./json/ZhongGuo_BianJie.json', {
              stroke: new Earth.Color.fromCssColorString('#ba6966'),
              strokeWidth: 5,
            })
          );
          ...
          // 添加长江黄河边界
          viewer.dataSources.add(
            Earth.GeoJsonDataSource.load('./json/ChangJiang_HuangHe.geojson', {
              stroke: new Earth.Color.fromCssColorString('#9bd0f1'),
              strokeWidth: 5,
            })
          );
          ...
          // 添加外国边界
          viewer.dataSources.add(
            Earth.GeoJsonDataSource.load('./json/WaiGuo_BianJie.json', {
              stroke: new Earth.Color.fromCssColorString('#ffffff'),
              strokeWidth: 5,
            })
          );
          ...
          //   Earth.GeoJsonDataSource.load('/Resource/GuoJia_DianWei.geojson', {
          ...
          //添加其他国家名称
          const lineChina = viewer.dataSources.add(
            Earth.GeoJsonDataSource.load('/Resource/China.geojson', {
              stroke: Earth.Color.PINK.withAlpha(0),
              strokeWidth: 3,
            })
          );

          lineChina.then((value) => {
            let labelTextStyle = new Earth.TextStyle({
              faceName: '宋体', // 字体设置暂不支持 - 底层接口无效
              foreColor: new Earth.Color.fromCssColorString('#ff0000'),
              width: 20,
              height: 20,
              align: Earth.TextAlignType.BottomCenter,
            });
